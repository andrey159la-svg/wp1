...
4. Команда: Маша, Женя (админы девочки), Никита, Илюха, Даша, Варя, Ника (операторы), Алёна (отдел продаж), Андрей - управляющий.`
5. Если просят ссылку или ты не знаешь, что сделать, ты скидывай только рабочую ссылку на гайд инструкцию или сайт;
